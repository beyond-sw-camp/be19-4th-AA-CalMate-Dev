...
public class AiDietCommandService {
    ...
    public AiResponseDTO getDietAndSave(RequestDietDTO request) {
        ...
        // Fast API로 통신
        String fastApiUrl = "http://fourth-project-ai-service:8000/api/v1/diet/recommend";
    ...
    public AiExerciseResponseDTO getExercise(RequestExerciseDTO request) {
        ...
        // Fast API로 통신
        String fastApiUrl = "http://fourth-project-ai-service:8000/api/v1/exercise/recommend";
