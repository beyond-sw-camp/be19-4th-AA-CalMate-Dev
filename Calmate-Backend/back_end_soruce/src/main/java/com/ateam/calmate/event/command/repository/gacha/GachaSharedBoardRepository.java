...
public interface GachaSharedBoardRepository extends JpaRepository<GachaSharedBoardEntity, Long> {
    ...
    long countByGachaEventIdAndBoardVersion(Long gachaEventId, Integer boardVersion);

    Optional<GachaSharedBoardEntity> findFirstByGachaEventId(Long gachaEventId);
}
