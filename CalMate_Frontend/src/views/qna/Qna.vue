    ...
    <section class="card">
      <form @submit.prevent="handleSubmit" class="form">
        ...
        <div class="form-row">
          ...
          <input v-model="form.title" class="input" placeholder="문의 제목을 입력하세요" required />
        </div>

        <div class="form-row">
          <label class="form-label">내용</label>
          <textarea v-model="form.content" class="input textarea" rows="6" placeholder="문의 내용을 상세히 입력해주세요" required></textarea>
        </div>
